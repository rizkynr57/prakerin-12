...
class ApiController extends Controller
{
    ...
    public function JoinBarangMasuk()
    {
        ...
        ->select('suppliers.nama_supplier', 'barangs.nama_barang as barang', 'barang_masuks.jumlah_pemasukan', 'barang_masuks.tgl_masuk')
        ->get();
    ...
    public function JoinBarangKeluar()
    {
        ...
        ->select('customers.nama', 'barangs.nama_barang as barang', 'barang_keluars.jumlah_pengiriman', 'barang_keluars.harga_satuan', 'barang_keluars.tujuan', 'barang_keluars.tgl_pengirimam')
        ->get();
        return response()->json([
            'success' => true,
