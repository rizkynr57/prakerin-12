    ...
    <div class="page-header text-blue-d2">
        ...
        <div class="page-tools">
            <div class="action-buttons">
                <a class="btn bg-white btn-light mx-1px text-95" href="{{ route('exportPDF.barangMasukAll') }}" data-title="PDF">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <span class="text-default-d3"><br></span>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div>
                            ...
                            <span class="text-600 text-110 text-blue align-middle"><br></span>
                        </div>
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Status:</span> <span class="badge badge-success badge-pill px-25">Clear</span></div>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
   ...
   @foreach($barangMasuk as $data)
                    <div class="text-95 text-secondary-d3">
                        <div class="row mb-2 mb-sm-0 py-25">
                            <div class="d-none d-sm-block col-1">{{ $no++ }}</div>
                            <div class="col-9 col-sm-5">{{ $data->supplier->nama_supplier }}</div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                ...
                                <div class="col-5">
                                    <span class="text-150 text-success-d3 opacity-2">${{$amount}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
