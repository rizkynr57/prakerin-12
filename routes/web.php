...
Route::middleware(['auth', 'verified'])->get('/cetak-supplier', [SupplierController::class, 'cetakSupplierPDF'])
                    ->middleware('role:admin')->name('exportPDF.suppliersAll');
...
Route::middleware(['auth', 'verified'])->get('/cetak-customer', [CustomerController::class, 'cetakCustomerPDF'])
                    ->middleware('role:admin')->name('exportPDF.customersAll');
...
Route::middleware(['auth', 'verified'])->get('/cetak-pdf', [BarangKeluarController::class, 'cetakPDF'])
...
Route::middleware(['auth', 'verified'])->get('/cetak-pdf', [BarangMasukController::class, 'cetakPDF'])
