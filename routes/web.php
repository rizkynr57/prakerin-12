...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/laporan-barangkeluar-all', BarangKeluarController::class, 'laporanBarangKeluarAll')->name('laporanBarangKeluarAll');
    ...
    Route::get('/laporan-barangmasuk-all', BarangMasukController::class, 'laporanBarangMasukAll')->name('laporanBarangMasukAll');
